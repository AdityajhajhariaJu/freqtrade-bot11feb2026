...
NEW_2H_STRATEGIES = [
    ...
    ADXDICrossStrategy(),           # S5:  Trend start detection (5m)
    FibonacciPullbackStrategy(),    # S6:  Buy the dip in trend (5m)
    ...
    VWAPBandReversionStrategy(),    # S10: Institutional mean reversion (5m)
    MultiTFEMARibbonStrategy(),     # S11: Multi-TF trend pullback (5m+15m)
...
NEW_CATEGORIES = {
    ...
    "reversion_2h": [
        ...
        "vwap_sd_reversion", "cmf_divergence",
    ],
    "structural_2h": [
        "fib_pullback", "bb_kc_squeeze", "funding_fade",
    ],
}
